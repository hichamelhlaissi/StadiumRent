...
export default class HistoryRoute extends Component {
    ...
    report(message) {
        if (message.length > 0){
            Alert.alert('Report message sent successfully!!','Your report message is: '+message);
        }else {
            Alert.alert('Erreur!!','Your report message is empty');
        }
    }
            ...
            <View style={styles.container}>
                {
                    ...
                    :
                        this.state.orders.length > 0
                            ...
                            : <View style={styles.noOrders}><Text>History orders is empty</Text></View>
                }
                <ModalWrapper
                    animationType="slide"
                    ...
                    <View style={{marginTop: 22}}>
                        <View>
                            ...
                            <View style={styles.reportsButtons}>
                                ...
                                <Button title="SEND" type="primary" onPress={() => {this.setModalVisible(!this.state.modalVisible);this.report(this.state.messageReport)}} />
                            </View>
                        </View>
                    </View>
                </ModalWrapper>
